# ✅ PATCHED: Latest langgraph checkpoint
...
class PersonalAssistant:
    def __init__(self, db_connection):
        # ✅ PATCHED: Use LocalCheckpointer instead of old SqliteSaver
        ...
        self.email_agent = Agent(
            ...
            model="gpt-3.5-turbo",  # just the model string
